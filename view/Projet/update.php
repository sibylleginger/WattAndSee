    ...
    <div style="margin: auto; display: flex; align-items: flex-start;">
        ...
        <div class="horizontal">
            ...
            <select style="display: block;" required name="statut" id="statut">
                ...
                <option value="En cours de montage" <?php if ($projet->getStatut()=='En attente') echo "selected "?> >En cours de montage</option>';
            </select>
            </div>
            <div>
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input"
                       ...
                       type="date" id="dateDepot" name="dateDepot">
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <textarea class="mdl-textfield__input" name="description" id="description" cols="250" rows="10" required><?php echo htmlspecialchars($projet->getDescription()) ?></textarea>
            ...
            <div class="horizontal">
                <div>
                    <div>
                        ...
                        <a href="index.php?controller=theme&action=create&codeProjet=<?php echo $projet->getCodeProjet()?>" class="addNew">
