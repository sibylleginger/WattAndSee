...
class ModelReporting extends Model
{

    protected static $object = 'Reporting';
    protected static $primary = 'codeReporting';
     ...
     * @return mixed
     */
    public function setSubEDF($subEDF)
    {
        $this->subEDF = $subEDF;
    }
     ...
     */
    public function setIsExceptionnel($isExceptionnel)
    {
     ...
     * @return mixed
     */
    public function getIsExceptionnel()
    {
        return $this->isExceptionnel;
    }
